...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Importa extrato(s) de conta corrente do Itaú (.xls) para o financiALL, de forma recorrente."
    )
    parser.add_argument("caminho", help="Arquivo .xls ou pasta com extratos")
    ...
    arquivos = _listar_arquivos_xls(args.caminho)
